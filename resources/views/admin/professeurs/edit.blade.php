...
@section('title', 'Éditer un Professeur')
...
<div class="p-8">
    ...
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-bold text-slate-900">Éditer Professeur</h1>
        <p class="text-slate-600 mt-2">{{ $professeur->nom }} {{ $professeur->prenom }}</p>
    </div>

    <!-- Form -->
    <div class="bg-white rounded-xl shadow-sm p-8 max-w-2xl">
        <form action="{{ route('admin.professeurs.update', $professeur) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid gap-6 sm:grid-cols-2">
                <div>
                    ...
                    <input type="text" name="code" value="{{ old('code', $professeur->code) }}" required
            ...
            <div class="grid gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="date" name="date_naissance" value="{{ old('date_naissance', optional($professeur->date_naissance)->format('Y-m-d')) }}"
            ...
            <div class="grid gap-6 sm:grid-cols-2">
                <div>
                    ...
                    <select name="grade" required
                        ...
                        <option value="assistant" {{ old('grade', $professeur->grade) === 'assistant' ? 'selected' : '' }}>Assistant</option>
                        <option value="ingenieur" {{ old('grade', $professeur->grade) === 'ingenieur' ? 'selected' : '' }}>Ingénieur</option>
