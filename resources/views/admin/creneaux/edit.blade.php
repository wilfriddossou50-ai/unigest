...
@section('title', 'Modifier le Créneau Horaire')
...
<div class="p-8 max-w-2xl mx-auto">
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-bold text-slate-900">Modifier le Créneau</h1>
        <p class="text-slate-600 mt-1">Ajustez la plage horaire globale pour la planification des cours et examens.</p>
    </div>
                ...
                <div class="flex items-start bg-slate-50 p-4 rounded-xl border border-slate-200">
                    <div class="flex items-center h-5">
                        <input id="est_actif"
                            ...
                            type="checkbox"
                            value="1"
                            {{ old('est_actif', $creneau->est_actif) ? 'checked' : '' }}
                    ...
                    <div class="ml-3 text-sm cursor-pointer select-none">
                        <label for="est_actif" class="font-semibold text-slate-800 cursor-pointer">Créneau actuellement actif</label>
                        <p class="text-slate-500 mt-0.5">Les créneaux désactivés n'apparaîtront pas lors de la gestion des plannings de cours.</p>
                    </div>
                </div>
