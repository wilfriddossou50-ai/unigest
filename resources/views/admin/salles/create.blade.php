...
<div class="p-8 max-w-2xl mx-auto">
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-bold text-slate-900">Ajouter une Salle</h1>
        <p class="text-slate-600 mt-1">Créez une nouvelle salle de classe ou d'examen pour l'établissement</p>
    </div>
